...
def translate(sentence):
    ...
    model = torch.load("model/spm_model_30ep.pth")
    model.eval()
...
@app.route('/')
def sample_form():
    return render_template('translate_web.html')

@app.route('/sampleform-post', methods=['POST'])
def sample_form_temp():
    print('--translating--')
    input_sentence = request.form['input_sentence']
    result = {'input_sentence':input_sentence, 'output_sentence':translate(input_sentence)}
